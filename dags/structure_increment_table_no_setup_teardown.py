"""
## Structure DAG showing an increment table pattern with no setup/ teardown tasks

This is a structure DAG that demonstrates a pattern of incrementing a table with
...
def structure_increment_table_no_setup_teardown():
    @task
    def upstream_task():
    ...
    def increment_table():
        ...
        chain(create_empty(), fetch_col_types_obj)
        ...
        fetch_col_types_obj >> drop_empty()
...
structure_increment_table_no_setup_teardown()
