"""
## Simple DAG showing setup and teardown methods used on TaskFlow API tasks
...
@dag(
    ...
    schedule=None,
    catchup=False,
    tags=["setup/teardown", "toy", "methods", "webinar"],
)
def simple_setup_teardown_methods():
    @task
    def upstream_task():
        return "hi"
    ...
    # define setup and teardown tasks and dependencies
    tear_down_cluster_obj.as_teardown(setups=[spin_up_cluster_obj])


simple_setup_teardown_methods()
